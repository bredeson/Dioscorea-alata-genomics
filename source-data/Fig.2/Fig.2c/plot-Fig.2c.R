...
DD = read.table("Fig.2c/Fig.2c.Dalata-delta.txt", stringsAsFactors=FALSE, header=FALSE)
Dd = read.table("Fig.2c/Fig.2c.Dalata-tau.txt", stringsAsFactors=FALSE, header=FALSE)
DR = read.table("Fig.2c/Fig.2c.Drotundata.txt", stringsAsFactors=FALSE, header=FALSE)
DT = read.table("Fig.2c/Fig.2c.Tzeylanicus.txt", stringsAsFactors=FALSE, header=FALSE)
DA = read.table("Fig.2c/Fig.2c.Acomosus.txt", stringsAsFactors=FALSE, header=FALSE)
DS = read.table("Fig.2c/Fig.2c.Spolyrhiza.txt", stringsAsFactors=FALSE, header=FALSE);
