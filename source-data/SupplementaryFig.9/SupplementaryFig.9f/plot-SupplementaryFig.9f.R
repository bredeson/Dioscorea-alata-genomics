...
DD = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Dalata-delta.txt", stringsAsFactors=FALSE, header=FALSE);
DR = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Drotundata.txt", stringsAsFactors=FALSE, header=FALSE);
DU = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Ddumetorum.txt", stringsAsFactors=FALSE, header=FALSE);
DZ = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Dzingiberensis.txt", stringsAsFactors=FALSE, header=FALSE);
DA = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Acomosus.txt", stringsAsFactors=FALSE, header=FALSE);
DE = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Eguineensis.txt", stringsAsFactors=FALSE, header=FALSE);
DS = read.table("SupplementaryFig.9f/SupplementaryFig.9f.Spolyrhiza.txt", stringsAsFactors=FALSE, header=FALSE);
